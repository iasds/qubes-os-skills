---
name: qubes-os-skills
description: "Community-driven SKILL.md collection for Qubes OS — qrexec, VM management, networking, security, and more."
triggers:
  - Qubes OS agent setup
  - qrexec skill
  - Qubes bind-dirs
  - Qubes VM management
  - Qubes networking
  - Qubes security hardening
  - Qubes template management
  - Qubes storage
  - help with Qubes OS
  - qubes AI agent skills
---
# Qubes OS Skills
